...
parser.add_argument('-l', '--labelmap', type=str, required=True, help='Directory containing the images')
parser.add_argument('-m', '--model', type=str, required=True, help='Directory containing the images')
...
input_normalization.options.mean = [128]
input_normalization.options.std = [128]
...
export_json_file = "meta_export.json"
